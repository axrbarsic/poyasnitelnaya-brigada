...
> самостоятельный local cron `x-15`. Сейчас он намеренно поставлен на паузу до
> очистки входящей очереди и отдельной команды Alex на возобновление.
...
- Автоматика `x-15` остаётся на паузе, пока входящая очередь не пуста и Alex
  отдельно не разрешил снова искать новые outbound-цели.
