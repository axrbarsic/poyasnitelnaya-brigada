...
7. Один существующий in-app heartbeat на Luna Low атомарно резервирует handoff
   и отправляет одно сообщение постоянному Browser owner. Reservation с TTL
   не позволяет двум соседним heartbeat отправить одинаковый wake.
