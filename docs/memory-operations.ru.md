...
12. Голосовой ввод не откладывает Browser, poll или очередь.
...
| --- | --- | ---: | ---: | ---: | --- |
| Экономный | давление памяти | 2200 MiB | 5 | минимум 20% | телеметрия |
...
Голосовой ввод не является сигналом resource guard. Он не меняет профиль и не
приостанавливает Browser-работу. Защита от давления памяти и системного сна
